...
! function(e) {
    ...
    "use strict";
    var i, a, r, o;
    "function" == typeof Symbol && Symbol.iterator, o = function(e) {
        return e
    ...
    o = function(e, t, n, i) {
        ...
        function u(r, o, c) {
            function d(e, t, n, a, r) {
                ...
                var s, l, u, p = [],
                    ...
                    m = v();
                do {
                    if (!0 === e && h().validPositions[f]) l = (u = r && !0 === h().validPositions[f].match.optionality && h().validPositions[f + 1] === i && (!0 === h().validPositions[f].generatedInput || h().validPositions[f].input == c.skipOptionalPartCharacter && f > 0) ? b(f, A(f, s, f - 1)) : h().validPositions[f]).match, s = u.locator.slice(), p.push(!0 === n ? u.input : !1 === n ? l.nativeDef : G(f, l));
                    else {
                        l = (u = x(f, s, f - 1)).match, s = u.locator.slice();
                        var d = !0 !== a && (!1 !== c.jitMasking ? c.jitMasking : l.jit);
                        (!1 === d || d === i || f < m || "number" == typeof d && isFinite(d) && d > f) && p.push(!1 === n ? l.nativeDef : G(f, l))
                    }
                    "auto" === c.keepStatic && l.newBlockMarker && null !== l.fn && (c.keepStatic = f - 1), f++
                } while ((Z === i || f < Z) && (null !== l.fn || "" !== l.def) || t > f);
                return "" === p[p.length - 1] && p.pop(), !1 === n && h().maskLength !== i || (h().maskLength = f - 1), c.greedy = o, p
            }
                    ...
                    function d(s, u, g) {
                        ...
                        if (s.matches !== i) {
                            if (s.isGroup && g !== s) {
                                ...
                                var x = s;
                                if (s = r(s, a, u, g)) {
                                    if (e.each(p, function(e, t) {
                                            t.match.optionality = !0
                                        }), o = p[p.length - 1].match, g !== i || !v(o, x)) return !0;
                                    f = !0, l = t
                                }
                                ...
                                if (-1 === w || "string" == typeof w) {
                                    ...
                                    for (var R = !1, N = 0; N < _.length; N++) {
                                        M = parseInt(_[N]), p = [], a = "string" == typeof w && k(l, M, E) || O.slice(), S.matches[M] && d(S.matches[M], [M].concat(u), g) ? s = !0 : 0 === N && (R = !0), P = p.slice(), l = D, p = [];
                                        for (var G = 0; G < P.length; G++) {
                                            var I = P[G],
                                                B = !1;
                                            I.match.jit = I.match.jit || R, I.alternation = I.alternation || E, b(I);
                                            for (var L = 0; L < A.length; L++) {
                                                ...
                                                if ("string" != typeof w || I.alternation !== i && -1 !== e.inArray(I.locator[I.alternation].toString(), _)) {
                                                    ...
                                                    if (q = H, null === (z = I).match.fn && null !== q.match.fn && q.match.fn.test(z.match.def, h(), t, !1, c, !1)) {
                                                        b(I, H) && (B = !0, A.splice(A.indexOf(H), 0, I));
                                                        break
                                                    }
                                                }
                                ...
                                for (var V = s, K = a.length > 0 ? a.shift() : 0; K < (isNaN(V.quantifier.max) ? K + 1 : V.quantifier.max) && l <= t; K++) {
                                    var U = n.matches[e.inArray(V, n.matches) - 1];
                                    if (s = d(U, [K].concat(u), U)) {
                                        if ((o = p[p.length - 1].match).optionalQuantifier = K > V.quantifier.min - 1, o.jit = K + U.matches.indexOf(o) >= V.quantifier.jit, v(o, U) && K > V.quantifier.min - 1) {
                                            f = !0, l = t;
                                            break
                                        }
                                        if (V.quantifier.jit !== i && isNaN(V.quantifier.max) && o.optionalQuantifier && h().validPositions[t - 1] === i) {
                                            p.pop(), f = !0, l = t, m = i;
                                            break
                                        }
                                        return !0
            ...
            function D(t, n, a, r, o) {
                var s, l, u, c, p, f, m, d = e.extend(!0, {}, h().validPositions),
                    y = !1,
                    b = o !== i ? o : v();
                if (-1 === b && o === i) l = (c = P(s = 0)).alternation;
                    ...
                    m = parseInt(s), h().excludes[m] = h().excludes[m] || [], !0 !== t && h().excludes[m].push(k(c));
                    var x = [],
                        S = 0;
                    for (p = m; p < v(i, !0) + 1; p++)(f = h().validPositions[p]) && !0 !== f.generatedInput ? x.push(f.input) : p < t && S++, delete h().validPositions[p];
                    for (; h().excludes[m] && h().excludes[m].length < 10;) {
                        ...
                        if (y && n !== i) {
                            var w = v(t) + 1;
                            for (p = m; p < v() + 1; p++)((f = h().validPositions[p]) === i || null == f.match.fn) && p < t + A && A++;
                        ...
                        for (h().excludes[m].push(M), p = m; p < v(i, !0) + 1; p++) delete h().validPositions[p]
                    }
                }
            ...
            function O(t, n, r, o, s, l) {
                ...
                function p(n, r, s) {
                    var l = !1;
                    return e.each(A(n), function(p, f) {
                        var m = f.match;
                        if (E(!0), !1 !== (l = null != m.fn ? m.fn.test(r, h(), n, s, c, u(t)) : (r === m.def || r === c.skipOptionalPartCharacter) && "" !== m.def && {
                                c: G(n, m, !0) || m.def,
                                pos: n
                            })) {
                            var d = l.c !== i ? l.c : r,
                                g = n;
                            return d = d === c.skipOptionalPartCharacter && null === m.fn ? G(n, m, !0) || m.def : d, l.remove !== i && (e.isArray(l.remove) || (l.remove = [l.remove]), e.each(l.remove.sort(function(e, t) {
                                return t - e
                            }), function(e, t) {
                                j({
                                    begin: t,
                                ...
                                O(t.pos, t.c, !0, o)
                            })), !0 !== l && l.pos !== i && l.pos !== n && (g = l.pos), (!0 === l || l.pos !== i || l.c !== i) && (j(t, e.extend({}, f, {
                ...
                if (e.isFunction(c.preValidation) && !r && !0 !== o && !0 !== l && (m = c.preValidation(E(), f, n, u(t), c, h())), !0 === m) {
                    if (_(i, f, !0), (Z === i || f < Z) && (m = p(f, n, r), (!r || !0 === o) && !1 === m && !0 !== l)) {
                    ...
                    }!1 !== m || !1 === c.keepStatic || null != c.regex && !U(E()) || r || !0 === s || (m = D(f, n, r, o)), !0 === m && (m = {
                        pos: f
                    })
                }
                ...
                return m && m.pos === i && (m.pos = f), !1 !== m && !0 !== l || (g(!0), h().validPositions = e.extend(!0, {}, d)), m
            }
            ...
            function j(t, n, a, r) {
                ...
                var s = t.begin !== i ? t.begin : t,
                    l = t.end !== i ? t.end : t;
                if (t.begin > t.end && (s = t.end, l = t.begin), r = r !== i ? r : s, s !== l || c.insertMode && h().validPositions[r] !== i && a === i) {
                    var u = e.extend(!0, {}, h().validPositions),
                        p = v(i, !0);
                    for (h().p = s, y = p; y >= s; y--) h().validPositions[y] && "+" === h().validPositions[y].match.nativeDef && (c.isNegative = !1), delete h().validPositions[y];
                    var f = !0,
                        m = r,
                        d = (h().validPositions, !1),
                        k = m,
                        y = m;
                    for (n && (h().validPositions[r] = e.extend(!0, {}, n), k++, m++, s < l && y++); y <= p; y++) {
                        var b = u[y];
                        if (b !== i && (y >= l || y >= s && !0 !== b.generatedInput && o(y, u, {
                                begin: s,
                                end: l
                            }))) {
                            for (;
                                "" !== P(k).match.def;) {
                                if (!1 === d && u[k] && u[k].match.nativeDef === b.match.nativeDef) h().validPositions[k] = e.extend(!0, {}, u[k]), h().validPositions[k].input = b.input, _(i, k, !0), m = k + 1, f = !0;
                                else if (S(k, b.match.def)) {
                                    var x = O(k, b.input, !0, !0);
                                    f = !1 !== x, m = x.caret || x.insert ? v() : k + 1, d = !0
                                } else if (!(f = !0 === b.generatedInput || b.input === c.radixPoint && !0 === c.numericInput) && "" === P(k).match.def) break;
                                if (f) break;
                                k++
                            }
            ...
            function T(e, t) {
                for (var n = e + 1;
                    "" !== P(n).match.def && (!0 === t && (!0 !== P(n).match.newBlockMarker || !F(n)) || !0 !== t && !F(n));) n++;
                return n
            }
            ...
            function R(e, t) {
                var n, i = e;
                if (i <= 0) return 0;
                for (; --i > 0 && (!0 === t && !0 !== P(i).match.newBlockMarker || !0 !== t && !F(i) && ((n = A(i)).length < 2 || 2 === n.length && "" === n[1].match.def)););
                return i
            }
            ...
            function N(t, n, a, r, o) {
                ...
                if (t !== i && (t.inputmask._valueSet(n.join("")), a === i || r !== i && "blur" === r.type ? Q(t, a, 0 === n.length) : H(t, a), !0 === o)) {
                    var u = e(t),
                        p = t.inputmask._valueGet();
                    ie = !0, u.trigger("input"), setTimeout(function() {
            ...
            function G(t, n, a) {
                if ((n = n || P(t).match).placeholder !== i || !0 === a) return e.isFunction(n.placeholder) ? n.placeholder(c) : n.placeholder;
                if (null === n.fn) {
            ...
            function I(t, n, r, o, s) {
                ...
                } - 1 === f ? (h().p = T(f), f = 0) : h().p = f, l.caretPos = {
                    begin: f
                }, e.each(u, function(n, a) {
                    if (a !== i)
                        if (h().validPositions[n] === i && u[n] === G(n) && F(n, !0) && !1 === O(n, u[n], !0, i, i, !0)) h().p++;
                        else {
                            var o = new e.Event("_checkval");
                            o.which = a.charCodeAt(0), p += a;
                            var s = v(i, !0);
                            ! function(e, t) {
                                return -1 !== d(!0, 0, !1).slice(e, T(e)).join("").replace(/'/g, "").indexOf(t) && !F(e) && (P(e).match.nativeDef === t.charAt(0) || null === P(e).match.fn && P(e).match.nativeDef === "'" + t.charAt(0) || " " === P(e).match.nativeDef && (P(e + 1).match.nativeDef === t.charAt(0) || null === P(e + 1).match.fn && P(e + 1).match.nativeDef === "'" + t.charAt(0)))
                            }(f, p) ? (m = se.keypressEvent.call(t, o, !0, !1, r, l.caretPos.begin)) && (f = l.caretPos.begin + 1, p = "") : m = se.keypressEvent.call(t, o, !0, !1, r, s + 1), m && (N(i, E(), m.forwardPosition, o, !1), l.caretPos = {
                                begin: m.forwardPosition,
                                end: m.forwardPosition
                            })
                        }
                }), n && N(t, E(), m ? m.forwardPosition : i, s || new e.Event("checkval"), s && "input" === s.type)
            }
            ...
            function H(a, r, o, s) {
                ...
                if (e.isArray(r) && (o = te ? r[0] : r[1], r = te ? r[1] : r[0]), r.begin !== i && (o = te ? r.begin : r.end, r = te ? r.end : r.begin), "number" == typeof r) {
                    ...
                    if (a.scrollLeft = u > a.scrollWidth ? u : 0, m || !1 !== c.insertMode || r !== o || o++, a.inputmask.caretPos = {
                            begin: r,
                            end: o
            ...
            function V(t) {
                ...
                for (n = s + 1; n < r.length; n++) c = (a = x(n, c, n - 1)).locator.slice(), l[n] = e.extend(!0, {}, a);
                var p = u && u.alternation !== i ? u.locator[u.alternation] : i;
                for (n = o - 1; n > s && ((a = l[n]).match.optionality || a.match.optionalQuantifier && a.match.newBlockMarker || p && (p !== l[n].locator[u.alternation] && null != a.match.fn || null === a.match.fn && a.locator[u.alternation] && M(a.locator[u.alternation].toString().split(","), p.toString().split(",")) && "" !== A(n)[0].def)) && r[n] === G(n, a.match); n--) o--;
                return t ? {
                    l: o,
                    def: l[o] ? l[o].match : i
                } : o
            ...
            function z(e, t, n, r, o) {
                if ((c.numericInput || te) && (t === a.keyCode.BACKSPACE ? t = a.keyCode.DELETE : t === a.keyCode.DELETE && (t = a.keyCode.BACKSPACE), te)) {
                    var s = n.end;
                    n.end = n.begin, n.begin = s
                }
                if (t === a.keyCode.BACKSPACE && (n.end - n.begin < 1 || !1 === c.insertMode) ? (n.begin = R(n.begin), h().validPositions[n.begin] !== i && h().validPositions[n.begin].input === c.groupSeparator && n.begin--, !1 === c.insertMode && n.end !== h().maskLength && n.end--) : t === a.keyCode.DELETE && n.begin === n.end && (n.end = F(n.end, !0) && h().validPositions[n.end] && h().validPositions[n.end].input !== c.radixPoint ? n.end + 1 : T(n.end) + 1, h().validPositions[n.begin] !== i && h().validPositions[n.begin].input === c.groupSeparator && n.end++), j(n), !0 !== r && !1 !== c.keepStatic || null !== c.regex) {
                    var l = D(!0);
                    if (l) {
                        var u = l.caret !== i ? l.caret : l.pos ? T(l.pos.begin ? l.pos.begin : l.pos) : v(-1, !0);
            ...
            function q(i) {
                ...
                r.style.width = a.width, r.style.textAlign = a.textAlign, J = n.createElement("div"), i.inputmask.colorMask = J, J.className = "im-colormask", i.parentNode.insertBefore(J, i), i.parentNode.removeChild(i), J.appendChild(i), J.appendChild(r), i.style.left = r.offsetLeft + "px", e(J).on("mouseleave", function(e) {
                    ...
                    }(e.clientX)), se.clickEvent.call(i, [e])
            ...
            function Q(e, t, a) {
                ...
                if (J !== i) {
                    var m = E();
                    if (t === i ? t = H(e) : t.begin === i && (t = {
                            begin: t,
                            end: t
                        }), !0 !== a) {
                        var d = v();
                        do {
                            h().validPositions[f] ? (s = h().validPositions[f], o = s.match, l = s.locator.slice(), r(m[f])) : (s = x(f, l, f - 1), o = s.match, l = s.locator.slice(), !1 === c.jitMasking || f < d || "number" == typeof c.jitMasking && isFinite(c.jitMasking) && c.jitMasking > f ? r(G(f, o)) : p = !1), f++
                        } while ((Z === i || f < Z) && (null !== o.fn || "" !== o.def) || d > f || p);
                        p && r(), n.activeElement === e && (u.splice(t.begin, 0, t.begin === t.end || t.end > h().maskLength ? '<mark class="im-caret" style="border-right-width: 1px;border-right-style: solid;">' : '<mark class="im-caret-select">'), u.splice(t.end + 1, 0, "</mark>"))
                    }
                                ...
                                if ("setvalue" === t.type || "FORM" === this.nodeName || !(n.disabled || n.readOnly && !("keydown" === t.type && t.ctrlKey && 67 === t.keyCode || !1 === c.tabThrough && t.keyCode === a.keyCode.TAB))) {
                                    switch (t.type) {
                                        ...
                                        case "keypress":
                                            ...
                                            break;
                                        case "click":
                                            if (f || m) return s = arguments, setTimeout(function() {
                                                r.apply(n, s)
                                            }, 0), !1
                                    }
                ...
                se = {
                    keydownEvent: function(t) {
                        var n = this,
                            ...
                            r = t.keyCode,
                            o = H(n);
                        if (r === a.keyCode.BACKSPACE || r === a.keyCode.DELETE || m && r === a.keyCode.BACKSPACE_SAFARI || t.ctrlKey && r === a.keyCode.X && !l("cut")) t.preventDefault(), z(0, r, o), N(n, E(!0), h().p, t, n.inputmask._valueGet() !== E().join(""));
                        else if (r === a.keyCode.END || r === a.keyCode.PAGE_DOWN) {
                            t.preventDefault();
                            var s = T(v());
                            c.insertMode || s !== h().maskLength || t.shiftKey || s--, H(n, t.shiftKey ? o.begin : s, s, !0)
                        } else r === a.keyCode.HOME && !t.shiftKey || r === a.keyCode.PAGE_UP ? (t.preventDefault(), H(n, 0, t.shiftKey ? o.begin : 0, !0)) : (c.undoOnEscape && r === a.keyCode.ESCAPE || 90 === r && t.ctrlKey) && !0 !== t.altKey ? (I(n, !0, !1, W.split("")), i.trigger("click")) : r !== a.keyCode.INSERT || t.shiftKey || t.ctrlKey ? !0 === c.tabThrough && r === a.keyCode.TAB ? (!0 === t.shiftKey ? (null === P(o.begin).match.fn && (o.begin = T(o.begin)), o.end = R(o.begin, !0), o.begin = R(o.end, !0)) : (o.begin = T(o.begin, !0), o.end = T(o.begin, !0), o.end < h().maskLength && o.end--), o.begin < h().maskLength && (t.preventDefault(), H(n, o.begin, o.end))) : t.shiftKey || !1 === c.insertMode && (r === a.keyCode.RIGHT ? setTimeout(function() {
                            var e = H(n);
                            H(n, e.begin)
                        }, 0) : r === a.keyCode.LEFT && setTimeout(function() {
                            var e = H(n);
                            H(n, te ? e.begin + 1 : e.begin - 1)
                        }, 0)) : (c.insertMode = !c.insertMode, H(n, c.insertMode || o.begin !== h().maskLength ? o.begin : o.begin - 1));
                        c.onKeyDown.call(this, t, E(), H(n).begin, c), ae = -1 !== e.inArray(r, c.ignorables)
                    },
                    keypressEvent: function(t, n, r, o, s) {
                        var l = this,
                            u = e(l),
                            p = t.which || t.charCode || t.keyCode;
                        if (!(!0 === n || t.ctrlKey && t.altKey) && (t.ctrlKey || t.metaKey || ae)) return p === a.keyCode.ENTER && W !== E().join("") && (W = E().join(""), setTimeout(function() {
                            u.trigger("change")
                        }, 0)), !0;
                        if (p) {
                            ...
                            if (c._radixDance && c.numericInput) {
                                ...
                                m.begin <= k && (p === c.radixPoint.charCodeAt(0) && (v = 1), m.begin -= 1, m.end -= 1)
                            }
                            h().writeOutBuffer = !0;
                            var y = O(m, d, o);
                            if (!1 !== y && (g(!0), f = y.caret !== i ? y.caret : T(y.pos.begin ? y.pos.begin : y.pos), h().p = f), f = (c.numericInput && y.caret === i ? R(f) : f) + v, !1 !== r && (setTimeout(function() {
                    ...
                    pasteEvent: function(n) {
                        ...
                        if (s === (te ? C().reverse() : C()).slice(0, o.begin).join("") && (s = ""), l === (te ? C().reverse() : C()).slice(o.end).join("") && (l = ""), t.clipboardData && t.clipboardData.getData) r = s + t.clipboardData.getData("Text") + l;
                        else {
                        ...
                        return I(this, !1, !1, u.toString().split("")), N(this, E(), T(v()), n, W !== E().join("")), n.preventDefault()
                    },
                    inputFallBackEvent: function(t) {
                        ...
                        if (E().join("") !== i) {
                            ...
                            if (i = function(e, t, n) {
                                ...
                                if (u !== m && (u.length > m.length ? h += u.slice(0, 1) : u.length < m.length && (d.end += m.length - u.length, g || "" === c.radixPoint || "" !== u || l.charAt(d.begin + s - 1) !== c.radixPoint || (d.begin--, h = c.radixPoint))), N(n, E(), {
                                        begin: d.begin + s,
                                        end: d.end + s
                                    ...
                                    d.begin === d.end - 1 && (d.begin = R(d.begin + 1), d.begin === d.end - 1 ? H(n, d.begin) : H(n, d.begin, d.end));
                                    var y = new e.Event("keydown");
                                    y.keyCode = c.numericInput ? a.keyCode.BACKSPACE : a.keyCode.DELETE, se.keydownEvent.call(n, y), !1 === c.insertMode && H(n, H(n).begin - 1)
                                }
                                t.preventDefault()
                            }
                        }
                        ...
                        if (t.cancelable) {
                            ...
                            switch (t.inputType) {
                                ...
                                case "deleteContentBackward":
                                    return (i = new e.Event("keydown")).keyCode = a.keyCode.BACKSPACE, se.keydownEvent.call(n, i), t.preventDefault();
                                case "deleteContentForward":
                                    var i;
                                    return (i = new e.Event("keydown")).keyCode = a.keyCode.DELETE, se.keydownEvent.call(n, i), t.preventDefault()
                            }
                        }
                    },
                    setValueEvent: function(t) {
                        ...
                        e.isFunction(c.onBeforeMask) && (n = c.onBeforeMask.call(X, n, c) || n), I(this, !0, !1, n = n.split("")), W = E().join(""), (c.clearMaskOnLostFocus || c.clearIncomplete) && this.inputmask._valueGet() === C().join("") && this.inputmask._valueSet("")
                    },
                    focusEvent: function(e) {
                        var t = this.inputmask._valueGet();
                        c.showMaskOnFocus && (!c.showMaskOnHover || c.showMaskOnHover && "" === t) && (this.inputmask._valueGet() !== E().join("") ? N(this, E(), T(v())) : !1 === re && H(this, T(v()))), !0 === c.positionCaretOnTab && !1 === re && se.clickEvent.apply(this, [e, !0]), W = E().join("")
                    },
                    mouseleaveEvent: function(e) {
                        if (re = !1, c.clearMaskOnLostFocus && n.activeElement !== this) {
                            var t = E().slice(),
                                i = this.inputmask._valueGet();
                            i !== this.getAttribute("placeholder") && "" !== i && (-1 === v() && i === C().join("") ? t = [] : K(t), N(this, t))
                        }
                    },
                    clickEvent: function(t, a) {
                        ...
                        setTimeout(function() {
                            if (n.activeElement === r) {
                                var t = H(r);
                                if (a && (te ? t.end = t.begin : t.begin = t.end), t.begin === t.end) switch (c.positionCaretOnClick) {
                                    case "none":
                                        break;
                                    case "select":
                                        H(r, 0, E().length);
                                    ...
                                    default:
                                        ...
                                        if (s < u) H(r, F(s, !0) || F(s - 1, !0) ? s : T(s));
                                            ...
                                            var p = h().validPositions[l],
                                                ...
                                                m = G(u, f.match);
                                            if ("" !== m && E()[u] !== m && !0 !== f.match.optionalQuantifier && !0 !== f.match.newBlockMarker || !F(u, c.keepStatic) && f.match.def === m) {
                                                var d = T(u);
                                                (s >= d || s === u) && (u = d)
                                            }
                                            H(r, u)
                    ...
                    cutEvent: function(i) {
                        ...
                        s.setData("text", te ? l.reverse().join("") : l.join("")), n.execCommand && n.execCommand("copy"), z(0, a.keyCode.DELETE, r), N(this, E(), h().p, i, W !== E().join(""))
                    },
                    blurEvent: function(t) {
                        ...
                        if (this.inputmask) {
                            var a = this.inputmask._valueGet(),
                                r = E().slice();
                            "" === a && J === i || (c.clearMaskOnLostFocus && (-1 === v() && a === C().join("") ? r = [] : K(r)), !1 === U(r) && (setTimeout(function() {
                                n.trigger("incomplete")
                            }, 0), c.clearIncomplete && (g(), r = c.clearMaskOnLostFocus ? [] : C().slice())), N(this, r, i, t)), W !== E().join("") && (W = r.join(""), n.trigger("change"))
                        }
                    },
                    mouseenterEvent: function(e) {
                        re = !0, n.activeElement !== this && c.showMaskOnHover && this.inputmask._valueGet() !== E().join("") && N(this, E())
                    },
                    submitEvent: function(e) {
                        W !== E().join("") && $.trigger("change"), c.clearMaskOnLostFocus && -1 === v() && ee.inputmask._valueGet && ee.inputmask._valueGet() === C().join("") && ee.inputmask._valueSet(""), c.clearIncomplete && !1 === U(E()) && ee.inputmask._valueSet(""), c.removeMaskOnSubmit && (ee.inputmask._valueSet(ee.inputmask.unmaskedvalue(), !0), setTimeout(function() {
                            N(ee, E())
                        }, 0))
                    },
            ...
            if (a.prototype.positionColorMask = function(e, t) {
                ...
                case "isComplete":
                    return ee = r.el, U(E());
                case "unmaskedvalue":
                    return ee !== i && r.value === i || (Y = r.value, Y = (e.isFunction(c.onBeforeMask) && c.onBeforeMask.call(X, Y, c) || Y).split(""), I.call(this, i, !1, !1, Y), e.isFunction(c.onBeforeWrite) && c.onBeforeWrite.call(X, i, E(), 0, c)), B(ee);
                case "mask":
                    ! function(t) {
                        oe.off(t);
                        var a = function(t, a) {
                            ...
                            return !1 !== o ? function(t) {
                                function r() {
                                    return this.inputmask ? this.inputmask.opts.autoUnmask ? this.inputmask.unmaskedvalue() : -1 !== v() || !0 !== a.nullable ? n.activeElement === this && a.clearMaskOnLostFocus ? (te ? K(E().slice()).reverse() : K(E().slice())).join("") : l.call(this) : "" : l.call(this)
                                }
                                ...
                                if (!t.inputmask.__valueGet) {
                                    if (!0 !== a.noValuePatching) {
                                        ...
                                        } else n.__lookupGetter__ && t.__lookupGetter__("value") && (l = t.__lookupGetter__("value"), u = t.__lookupSetter__("value"), t.__defineGetter__("value", r), t.__defineSetter__("value", o));
                                    ...
                                    t.inputmask._valueGet = function(e) {
                                        ...
                                        u.call(this.el, null === e || e === i ? "" : !0 !== t && te ? e.split("").reverse().join("") : e)
                                    }, l === i && (l = function() {
                                        return this.value
                                    }, u = function(e) {
                                        this.value = e
        ...
        return a.prototype = {
            ...
            mask: function(s) {
                ...
                return "string" == typeof s && (s = n.getElementById(s) || n.querySelectorAll(s)), s = s.nodeName ? [s] : s, e.each(s, function(n, s) {
                    ...
                    if (function(n, a, o, s) {
                        ...
                        p !== i && (s.inputmask !== i && (s.inputmask.opts.autoUnmask = !0, s.inputmask.remove()), s.inputmask = new a(i, i, !0), s.inputmask.opts = c, s.inputmask.noMasksCache = l.noMasksCache, s.inputmask.userOptions = e.extend(!0, {}, l.userOptions), s.inputmask.isRTL = c.isRTL || c.numericInput, s.inputmask.el = s, s.inputmask.maskset = p, e.data(s, "_inputmask_opts", c), u.call(s.inputmask, {
                            action: "mask"
                        }))
                    }
            ...
            unmaskedvalue: function(e) {
                return this.maskset = this.maskset || o(this.opts, this.noMasksCache), u.call(this, {
            ...
            analyseMask: function(t, n, r) {
                ...
                function s(t, o, s) {
                    ...
                    var l = t.matches[s - 1];
                    if (n) 0 === o.indexOf("[") || k && /\\d|\\s|\\w]/i.test(o) || "." === o ? t.matches.splice(s++, 0, {
                        ...
                        placeholder: i,
                        nativeDef: o
                    }) : (k && (o = o[o.length - 1]), e.each(o.split(""), function(e, n) {
                ...
                var c, p, f, m, d, h, g = /(?:[?*+]|\{[0-9\+\*]+(?:,[0-9\+\*]*)?(?:\|[0-9\+\*]*)?\})|[^.?*+^${[]()|\\]+|./g,
                    v = /\[\^?]?(?:[^\\\]]+|\\[\S\s]?)*]?|\\(?:0(?:[0-3][0-7]{0,2}|[4-7][0-7]?)?|[1-9][0-9]*|x[0-9A-Fa-f]{2}|u[0-9A-Fa-f]{4}|c[A-Za-z]|[\S\s]?)|\((?:\?[:=!]?)?|(?:[?*+]|\{[0-9]+(?:,[0-9]*)?\})\??|[^.?*+^${[()|\\]+|./g,
                    k = !1,
                    y = new o,
                    b = [],
                    x = [];
                for (n && (r.optionalmarker[0] = i, r.optionalmarker[1] = i); c = n ? v.exec(t) : g.exec(t);) {
                    ...
                    if (k) l();
                        ...
                        case r.alternatormarker:
                            ...
                            if (b.length > 0) {
                                ...
                                h = m.openGroup && (j.matches === i || !1 === j.isGroup && !1 === j.isAlternator) ? b.pop() : _(m.matches)
                            } else h = _(y.matches);
                            if (h.isAlternator) b.push(h);
                            else if (h.alternatorGroup ? (d = b.pop(), h.alternatorGroup = !1) : d = new o(!1, !1, !1, !0), d.matches.push(h), b.push(d), h.openGroup) {
                                h.openGroup = !1;
                                var F = new o(!0);
                ...
                return y.matches.length > 0 && (function T(t) {
                    t && t.matches && e.each(t.matches, function(e, a) {
                        var o = t.matches[e + 1];
                        (o === i || o.matches === i || !1 === o.isQuantifier) && a && a.isGroup && (a.isGroup = !1, n || (s(a, r.groupmarker[0], 0), !0 !== a.openGroup && s(a, r.groupmarker[1]))), T(a)
                    })
                }(y), x.push(y)), (r.numericInput || r.isRTL) && function R(e) {
                    for (var t in e.matches = e.matches.reverse(), e.matches)
                        if (e.matches.hasOwnProperty(t)) {
                            ...
                            e.matches[t].matches !== i ? e.matches[t] = R(e.matches[t]) : e.matches[t] = ((o = e.matches[t]) === r.optionalmarker[0] ? o = r.optionalmarker[1] : o === r.optionalmarker[1] ? o = r.optionalmarker[0] : o === r.groupmarker[0] ? o = r.groupmarker[1] : o === r.groupmarker[1] && (o = r.groupmarker[0]), o)
                        }
                    var o;
                    return e
                }(x[0]), x
    ...
    "use strict";
    var i, a, r, o;
    "function" == typeof Symbol && Symbol.iterator, o = function(e, t) {
        function n(e) {
            if (!e.tokenizer) {
                var t = [];
        ...
        function r(e, t, i) {
            function a(e, t, n) {
                "year" === r ? (e[r] = function(e) {
                    var t = 4 === e.length ? e : (new Date).getFullYear().toString().substr(0, 4 - e.length) + e;
                    return i.min && i.min.year && i.max && i.max.year ? (t = t.replace(/[^0-9]/g, ""), t += i.min.year == i.max.year ? i.min.year.substr(t.length) : ("" !== t && 0 == i.max.year.indexOf(t) ? parseInt(i.max.year) - 1 : parseInt(i.min.year) + 1).toString().substr(t.length)) : t = t.replace(/[^0-9]/g, "0"), t
                }(t), e["raw" + r] = t) : e[r] = n.min && t.match(/[^0-9]/) ? n.min[r] : t, void 0 !== l && l.call(e.date, "month" == r ? parseInt(e[r]) - 1 : e[r])
            }
            var r, s, l, u = {
                    date: new Date(1, 0, 1)
                },
            ...
            if ("string" == typeof c) {
                for (; s = n(i).exec(t);) {
                    ...
                    o.hasOwnProperty(s[0]) && (r = o[s[0]][2], l = o[s[0]][1], a(u, p, i)), c = c.slice(p.length)
                }
                return u
            }
        }
            ...
            datetime: {
                ...
                postValidation: function(e, t, n) {
                    ...
                    return i && a.date.getTime() == a.date.getTime() && (i = (i = function(e, t) {
                        ...
                        var n = !0;
                        return t.min && t.min.date.getTime() == t.min.date.getTime() && (n = t.min.date.getTime() <= e.date.getTime()), n && t.max && t.max.date.getTime() == t.max.date.getTime() && (n = t.max.date.getTime() >= e.date.getTime()), n
                    }(a, n)), i
                },
                onKeyDown: function(i, r, o, s) {
                    if (i.ctrlKey && i.keyCode === t.keyCode.RIGHT) {
                        for (var l, u = new Date, c = ""; l = n(s).exec(s.inputFormat);) "d" === l[0].charAt(0) ? c += a(u.getDate(), l[0].length) : "m" === l[0].charAt(0) ? c += a(u.getMonth() + 1, l[0].length) : "yyyy" === l[0] ? c += u.getFullYear().toString() : "y" === l[0].charAt(0) && (c += a(u.getYear(), l[0].length));
    ...
    "use strict";
    var i, a, r, o;
    "function" == typeof Symbol && Symbol.iterator, o = function(e, t, n) {
        function i(e, n) {
    ...
    "function" == typeof Symbol && Symbol.iterator, o = function(e, t) {
        ...
        return t.prototype.analyseMask = function(t, n, a) {
            var r = {};
            return a.phoneCodes && (a.phoneCodes && a.phoneCodes.length > 1e3 && (function o(e, n, i) {
                n = n || "", i = i || r, "" !== n && (i[n] = {});
                for (var a = "", s = i[n] || i, l = e.length - 1; l >= 0; l--) s[a = (t = e[l].mask || e[l]).substr(0, 1)] = s[a] || [], s[a].unshift(t.substr(1)), e.splice(l, 1);
                for (var u in s) s[u].length > 500 && o(s[u].slice(), u, s)
            }((t = t.substr(1, t.length - 2)).split(a.groupmarker[1] + a.alternatormarker + a.groupmarker[0])), t = function s(t) {
                var n = "",
                    i = [];
                for (var r in t) e.isArray(t[r]) ? 1 === t[r].length ? i.push(r + t[r]) : i.push(r + a.groupmarker[0] + t[r].join(a.groupmarker[1] + a.alternatormarker + a.groupmarker[0]) + a.groupmarker[1]) : i.push(r + s(t[r]));
