! function($, c, i, n) {
    ...
    t.prototype.onReset = function(t) {
        ...
        }), a.product_id = parseInt(i.$form.data("product_id"), 10), a.custom_data = i.$form.data("custom_data"), i.xhr = $.ajax({
        ...
        w.useAjax || (w.$attributeFields.each(function(t, a) {
            ...
            c = o.find("option.attached").length, n && (s = !1, 0 !== c && o.find("option.attached.enabled").each(function() {
                var t = $(this).val();
                if (n === t) return !(s = !0)
            })), 0 < c && n && s && "no" === r && (o.find("option:first").remove(), a = ""), o.find("option" + a + ":not(.attached)").remove(), i.html(o.html()), i.find("option" + a + ":not(.enabled)").prop("disabled", !0), n ? s ? i.val(n) : i.val("").trigger("change") : i.val("")
