! function(t) {
    ...
    }, n.p = "https://widget-v4.tidiochat.com/", n.h = "326fdf51a69c63448a75", n.cn = "render", n(n.s = 221)
}([, , , , , , , , function(t, e, n) {
    (function(e) {
        var n = function(t) {
        ...
        if (n = h ? r : y ? r[v] || u(v, {}) : (r[v] || {}).prototype)
            for (s in e) {
                if (d = e[s], l = t.noTargetGet ? (p = o(n, s)) && p.value : n[s], !f(h ? s : v + (y ? "." : "#") + s, t.forced) && void 0 !== l) {
                    ...
                    a(d, l)
                }(t.sham || l && l.sham) && i(d, "sham", !0), c(n, s, d, t)
            }
    }
}, function(t, e) {
    ...
    (t.exports = function(t, e, n, u) {
        var a, f = !!u && !!u.unsafe,
            d = !!u && !!u.enumerable,
            p = !!u && !!u.noTargetGet;
        "function" == typeof n && ("string" != typeof e || i(n, "name") || o(n, "name", e), (a = s(n)).source || (a.source = l.join("string" == typeof e ? e : ""))), t !== r ? (f ? !p && t[e] && (d = !0) : delete t[e], d ? t[e] = n : o(t, e, n)) : d ? t[e] = n : c(e, n)
        ...
        concat: function(t) {
            ...
            for (e = -1, r = arguments.length; e < r; e++)
                if (g(i = -1 === e ? c : arguments[e])) {
                    if (d + (o = a(i.length)) > 9007199254740991) throw TypeError("Maximum allowed index exceeded");
    ...
    (a || s || f) && (u = function(t) {
        var e, n, o, u, l = this,
            ...
            h = 0,
            y = t;
        return d && (-1 === (p = p.replace("y", "")).indexOf("g") && (p += "g"), y = String(t).slice(l.lastIndex), l.lastIndex > 0 && (!l.multiline || l.multiline && "\n" !== t[l.lastIndex - 1]) && (v = "(?: " + v + ")", y = " " + y, h++), n = new RegExp("^(?:" + v + ")", p)), s && (n = new RegExp("^" + v + "$(?!\\s)", p)), a && (e = l.lastIndex), o = i.call(d ? n : l, y), d ? o ? (o.input = o.input.slice(h), o[0] = o[0].slice(h), o.index = l.lastIndex, l.lastIndex += o[0].length) : l.lastIndex = 0 : a && o && (l.lastIndex = l.global ? o.index + o[0].length : e), s && o && o.length > 1 && c.call(o[0], n, (function() {
    ...
    r("replace", 2, (function(t, e, n, r) {
        ...
        return [function(n, r) {
            ...
            for (var b, S = "", O = 0, T = 0; T < w.length; T++) {
                _ = w[T];
                for (var P = String(_[0]), k = l(d(c(_.index), g.length), 0), I = [], C = 1; C < _.length; C++) I.push(void 0 === (b = _[C]) ? b : String(b));
                var j = _.groups;
                if (x) {
                    var R = [P].concat(I, k, g);
                    void 0 !== j && R.push(j);
                    var A = String(r.apply(void 0, R))
                } else A = f(P, g, k, I, j, r);
                k >= O && (S += g.slice(O, k) + A, O = k + P.length)
            }
            return S + g.slice(O)
        }]
    }))
    ...
    t.exports = function(t, e, n, a, f, s) {
        var l = n + t.length,
            d = a.length,
            p = u;
        return void 0 !== f && (f = r(f), p = c), i.call(s, p, (function(r, i) {
            var c;
            switch (i.charAt(0)) {
                case "$":
                    return "$";
    ...
    ! function() {
        ...
        var r = function() {
            ...
            return function(i, c) {
                ...
                return e ? (setTimeout((function() {
                    ...
                    fn: i,
                    ctx: c
                }), "complete" === document.readyState || !document.attachEvent && "interactive" === document.readyState ? setTimeout(r, 1) : n || (document.addEventListener ? (document.addEventListener("DOMContentLoaded", r, !1), window.addEventListener("load", r, !1)) : (document.attachEvent("onreadystatechange", o), window.attachEvent("onload", r)), n = !0), !0)
            }
        }();
        ...
        function o(t) {
            ! function(t, e) {
                ...
                r.src = e, r.async = !0, n.body.appendChild(r)
            }(t, "".concat(e.replace(/\/$/, ""), "/").concat("1_141_0", "/static/js/widget.").concat(n.h, ".js"))
        }
        var i = n(223).default;
        window.tidioChatApi = new i, r((function() {
            return setTimeout((function() {
                ...
                ! function(t, e, n) {
                    ...
                    r.onload = function() {
                        o || (n(r), o = !0)
                    }, r.id = t, r.style.display = "none", r.title = "Tidio Chat code", e.body.appendChild(r), setTimeout((function() {
                        o || (n(r), o = !0)
                    }), 1e3)
                }("tidio-chat-code", window.document, (function(r) {
                    t && window.__REDUX_DEVTOOLS_EXTENSION__ && (r.contentWindow.__REDUX_DEVTOOLS_EXTENSION__ = window.__REDUX_DEVTOOLS_EXTENSION__, r.contentWindow.__REDUX_DEVTOOLS_EXTENSION_COMPOSE__ = window.__REDUX_DEVTOOLS_EXTENSION_COMPOSE__),
                        function(t) {
                            var r = "//localhost:3000/static/js/WidgetIframe.js";
                            r = "".concat(e).concat("1_141_0", "/static/js/chunk-WidgetIframe-").concat(n.h, ".js");
                            var o = t.createElement("link");
                            o.rel = "preload", o.as = "script", o.href = r, t.head.appendChild(o)
                        }(r.contentWindow.document),
                        function(t) {
                            var e = t.createElement("link");
                            e.rel = "preload", e.href = "".concat("https://widget-v4.tidiochat.com/", "fonts/mulish_SGhgqk3wotYKNnBQ.woff2"), e.as = "font", e.type = "font/woff2", e.crossOrigin = "", t.head.appendChild(e)
                        }(r.contentWindow.document),
                        function(t) {
                            var n = "".concat(e, "/tururu.mp3"),
                                r = t.createElement("audio");
                            r.preload = "metadata", r.src = n, t.head.appendChild(r)
                        }(r.contentWindow.document),
                        function(t) {
                            var e = t.createElement("link");
                        ...
                        }(r.contentWindow.document), r.contentWindow.tidioChatApi = window.tidioChatApi, "requestIdleCallback" in window ? window.requestIdleCallback((function() {
                            o(r)
                        }), {
                            timeout: 5e3
                        }) : setTimeout((function() {
